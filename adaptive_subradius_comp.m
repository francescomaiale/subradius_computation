...
% This function (Algorithm (A) in the main paper) computes a lower and upper bound for the lower spectral radius of a matrix family {A_1, ..., A_m} starting from an initial polytope antinorm and refining it adaptively. 
