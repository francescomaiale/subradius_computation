...
A=[-z V;0 -ones(1,m)]; % Augmented matrix as discussed in Algorithm SM.1.1
...
if (EXITFLAG<0) % If EXITFLAG is less than 0, then there was an error.
    
    if (EXITFLAG==-2) % If EXITFLAG = -2, no feasible point was found. In this case, we set the antinorm of z equal to 0.
        lower = 0; upper = 0;
